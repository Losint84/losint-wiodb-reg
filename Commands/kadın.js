...
exports.run = async(client, message, args) => {
   ...
   kullanıcı.roles.add(Settings.Roles.GirlRole1)
   kullanıcı.roles.add(Settings.Roles.GirlRole2)
  ...
  Kullanıcıya <@&${Settings.Roles.GirlRole1}>,<@&${Settings.Roles.GirlRole2}> Rolleri Verildi.
